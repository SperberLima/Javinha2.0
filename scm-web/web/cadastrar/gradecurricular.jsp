        ...
        <div id="content" class="" style="">  
            ...
            <div id="wrapper" class="">
                ...
                <div class="form_container">
                    <h1 class="form_title">Cadastro de grade curricular</h1>



                    <form name="frmGradeCurricular" method="post" action=""><table style="">
                            <input type="hidden" name="table" value="GradeCurricular" />
                            <tbody>
                                <tr style="">
                                ...
                                <tr>
                                    ...
                                    <td><input class="form_input" name="numero" type="text" placeholder="Número da série"></td>
                                </tr> 
                                <tr>
                    ...
                    <div class="butcontainer">
                        ...
                        <button onclick="GravarInsercao(document.frmGradeCurricular)" class="confirma" style=" height: 35px;width: 120px; margin-left: 15px;">CONFIRMA</button> 
