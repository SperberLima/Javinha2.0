        ...
        <div id="content" class="" style="">  
            ...
            <div id="wrapper" class="">
                ...
                <div class="form_container">
                    <h1 class="form_title">Cadastro de Curso</h1>



                    <form name="frmCurso" method='post'><table>
                            ...
                            <tbody>
                                <tr style="">
                                    <td id="field" style="
                                        "><span style="
                                            font-size: 16px;
                                            ">ID</span></td>
                                    <td><input class="form_input" name="" type="text" name="id" placeholder="ID"></td>
                                </tr>
                                <tr>
                                ...
                                <tr style="
                                    ...
                                    <td><input class="form_input" name="" type="text" name="nome" placeholder="Nome"></td>
                                </tr>
                                <tr>
                                    <td id="field"><span>Sigla</span></td> 
                                    <td><input class="form_input" name="nome" type="text" placeholder="Sigla"></td>
                                </tr>
                                <tr>
                                    <td id="field"><span>Tipo</span></td> 
                                    <td><input class="form_input" name="nome" type="text" placeholder="Tipo"></td>
                                </tr>
                            </tbody></table>
                    ...
                    <button onclick="GravarInsercao(document.frmCurso)" class="confirma" style="
                            height: 35px;
                            width: 120px;
                            margin-left: 15px;
                            ">CONFIRMA</button> 
