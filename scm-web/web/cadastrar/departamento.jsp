        ...
        <div id="content" class="" style="">  
            ...
            <div id="wrapper" class="">
                ...
                <div class="form_container">
                    <h1 class="form_title">Cadastro de departamento</h1>



                    <form name="frmDepartamento" method='post'><table style="">
                            <input type="hidden" name="table" value="Departamento" />
                            <tbody>
                                <tr>
                                    <td id="field" ><span style="    font-size: 16px;">ID</span></td>
                                ...
                                <tr>
                                    <td id="field"><span>E-mail</span></td>
                                    <td><input class="form_input" name="email" type="text" placeholder="E-mail" style=""></td>
                                </tr>
                                <tr>
                                    <td id="field" style=""><span>Telefone</span></td>
                                    <td><input class="form_input" name="telefone" type="text" placeholder="Telefone" style=""></td>
                                </tr>
                                <tr>
                                    <td id="field" style=""><span>CEP</span></td>
                                    <td><input class="form_input" name="cep"  type="text" placeholder="CEP" style=""></td>
                                </tr> 
                                <tr style="border: 1px solid gray;">
                                    <td id="field" style=""><span>Site</span></td>
                                    <td><input class="form_input" name="site" type="text" placeholder="Site" style=""></td>
                                </tr>  
                            </tbody></table>
                    </form>
                    <div class="butcontainer">
                        <input type="reset" value="CANCELAR" class="cancela" style=" height: 35px; width: 120px;">
                        <button onclick="GravarInsercao(document.frmDepartamento)" class="confirma" style="    height: 35px;    width: 120px;    margin-left: 15px;">CONFIRMA</button> 
