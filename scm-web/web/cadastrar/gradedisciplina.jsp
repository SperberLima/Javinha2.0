        ...
        <div id="content" class="" style="">  
            ...
            <div id="wrapper" class="">
                ...
                <div class="form_container">
                    <h1 class="form_title">Cadastro de relação grade disciplina</h1>



                    <form name="frmGradeDisciplina" method="post" action=""><table style="">
                           <input type="hidden" name="table" value="GradeDisciplina" />
                            <tbody>
                                <tr style="">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="grade" class="form_input">
                                            <%
                                                List<GradeCurricular> grade = (List<GradeCurricular>) request.getAttribute("grade");
                                                for (GradeCurricular gra : grade) {
                                            %>
                                            <option                                     
                    ...
                    <div class="butcontainer">
                        ...
                        <button onclick="GravarInsercao(document.frmGradeDisciplina)" class="confirma" style="height: 35px;width: 120px;margin-left: 15px;">CONFIRMA</button> 
