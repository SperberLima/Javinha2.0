            ...
            <div id="wrapper" class="">
                ...
                <div class="opt_container" style="
                    ...
                    <form name="frmEscolha" method='post'>
                        <h1 class="form_title" style=>Selecione uma operação para 
                            <select id="sEscolha" name="select" style="
                                border: none;
                                background: inherit;
                                ...
                                font-size: x-large;"
                            >
                                <option value="AmbienteAprendizagem">Ambiente</option>
                                ...
                                <option value="CurriculoOferta">Curriculo Ofertado</option>
                            </select></h1> </form>
                    <ul class="opt" style="">
