...
<% AmbienteAprendizagem ambiente = (AmbienteAprendizagem) request.getAttribute("ambiente");%>
        ...
        <div id="content" class="" style="">  
            ...
            <div id="wrapper" class="">
                ...
                <div class="form_container">
                    <h1 class="form_title">Alterar dados de Aprendizado</h1>
                    ...
                    <form name="frmAmbiente" method="post" action=""><table style="
                            ...
                            <tbody>
                                <tr style="">
                                    <td id="field" style="
                                        "><span style="
                                            font-size: 16px;
                                            ">ID</span></td>
                                    <td><input class="form_input" name="id" type="text" value="<%= ambiente.getId()%>" placeholder="ID"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><input class="form_input" name="descricao" type="text" value="<%= ambiente.getDescricao()%>" placeholder="Descrição"></td>
                                </tr>
                                <tr style="
                                    ">
                                    <td id="field"><span>Capacidade</span></td>
                                    <td><input class="form_input" name="capacidade" type="text" value="<%=ambiente.getCapacidade()%>" placeholder="Capacidade"></td>
                                </tr>
                                <tr style="border: 1px solid gray;">
                                    <td id="field" style="
                                        "><span>Número da sala</span></td> 
                                    <td><input class="form_input" name="numero" type="text" value="<%= ambiente.getSala()%>" placeholder="Número da sala" style="
                                               "></td>
                                </tr> 
                            </tbody></table>
                        <div class="butcontainer">
                            <input type="reset" value="CANCELAR" class="cancela" style=" height: 35px; width: 120px;">
                            <button onclick="GravarAlteracao(document.frmAmbiente)" class="redefine" style="height: 35px;width: 120px;margin-left: 15px;">REDEFINIR</button> 
