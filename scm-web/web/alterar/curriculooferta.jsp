...
<% CurriculoOferta curriculo = (CurriculoOferta) request.getAttribute("curriculo");%>
        ...
        <div id="content" class="" style="">  
            ...
            <div id="wrapper" class="">
                ...
                <div class="form_container">
                    <h1 class="form_title">Alterar dados de currículo ofertado</h1>



                    <form name="frmCurriculo" method="post" action=""><table style="">
                            <tbody>
                                <tr style="">
                                    <td id="field" style=""><span style="font-size: 16px;">ID</span></td>
                                    <td><input class="form_input" name="id" type="text" value="<%= curriculo.getId()%>" placeholder="ID"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td id="field"><span>Período Letivo</span></td>
                                    <td>
                                        <select name="periodo" class="form_input">
                                            <%
                                                List<PeriodoLetivo> listPeriodo = (List<PeriodoLetivo>) request.getAttribute("listPeriodo");
                                                for (PeriodoLetivo per : listPeriodo) {
                                            %>
                                            <option                                     
                                                value='<%=per.getId()%>'><%=per.getDescricao()%>
                                            </option>
                                            <%  }%>
                                        </select>
                                    </td> 
                        ...
                        <div class="butcontainer">
                            ...
                            <button onclick="GravarAlteracao(document.frmCurriculo)" class="redefine" style="height: 35px;width: 120px;margin-left: 15px;">REDEFINIR</button> 
