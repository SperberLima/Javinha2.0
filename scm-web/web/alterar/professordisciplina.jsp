...
<% ProfessorDisciplina professordisciplina = (ProfessorDisciplina) request.getAttribute("professordisciplina");%>
        ...
        <div id="content" class="" style="">  
            ...
            <div id="wrapper" class="">
                ...
                <div class="form_container">
                    <h1 class="form_title">Alterar dados da relação Professor Disciplina</h1>



                    <form name="frmProfessorDisciplina" method="post" action=""><table style="">
                            <tbody>
                                <tr style="">
                                    <td id="field" style="
                                        "><span style="
                                            font-size: 16px;
                                            ">ID</span></td>
                                    <td><input class="form_input" name="id" type="text" value="<%= professordisciplina.getId()%>" placeholder="ID"></td>
                                </tr>
                                <tr>
                                    <td id="field"><span>Professor</span></td>
                                    <td>
                                        <select name="professor" class="form_input">
                                            <%
                                                List<Professor> listProfessor = (List<Professor>) request.getAttribute("listProfessor");
                                                for (Professor pro : listProfessor) {
                                            %>
                                            <option                                     
                                                value='<%=pro.getId() %>'><%=pro.getNome()%>
                                            </option>
                                            <%  }%>
                                        </select>
                                    </td>  
                                ...
                                <tr>
                                    <td id="field"><span>Disciplina</span></td>
                        ...
                        <div class="butcontainer">
                            ...
                            <button onclick="GravarAlteracao(document.frmProfessorDisciplina)" class="redefine" style="height: 35px;width: 120px;margin-left: 15px;">REDEFINIR</button> 
