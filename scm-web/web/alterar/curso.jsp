        ...
        <div id="content" class="" style="">  
            ...
            <div id="wrapper" class="">
                ...
                <div class="form_container">
                    <h1 class="form_title">Alterar dados de curso</h1>



                    <form name="frmCurso" method="post" action=""><table style="
                                                                         ">
                            <tbody>
                                <tr style="">
                                    <td id="field" style="
                                        "><span style="
                                            font-size: 16px;
                                            ">ID</span></td>
                                    <td><input class="form_input" name="id" type="text" value="<%= curso.getId()%>" placeholder="ID"></td>
                                </tr>
                                <tr>
                                    <td id="field"><span>Departamento</span></td>
                                    <td>
                                        <select name="SDepartamento" class="form_input">
                                            <%
                                ...
                                <tr>
                                    ...
                                    <td><input class="form_input" name="nome" type="text" value="<%= curso.getNome()%>" placeholder="Nome"></td>
                                </tr>
                                <tr>
                                    <td id="field"><span>Sigla</span></td> 
                                    <td><input class="form_input" name="nome" type="text" value="<%= curso.getSigla()%>" placeholder="Sigla"></td>
                                </tr>
                                <tr>
                                    <td id="field"><span>Tipo</span></td> 
                                    <td><input class="form_input" name="nome" type="text" value="<%= curso.getTipo()%>" placeholder="Tipo"></td>
                                </tr>
                            </tbody></table>
