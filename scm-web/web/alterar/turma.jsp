        ...
        <div id="content" class="" style="">
            ...
            <div id="wrapper" class="">
                ...
                <div class="form_container">
                    <h1 class="form_title">Alterar dados de turma</h1>
                    ...
                    <form name="frmTurma " method="post" action=""><table style="">
                            <tbody>
                                <tr style="">
                                    ...
                                    <td><input class="form_input" name="id" type="text" value="<%= turma.getId()%>" placeholder="ID"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><input class="form_input" name="descricao" type="text" value="<%= turma.getNome()%>" placeholder="Nome"></td>
                                </tr>
                            </tbody></table>
                        <div class="butcontainer">
                            <input type="reset" value="CANCELAR" class="cancela" style=" height: 35px; width: 120px;">
                            <button onclick="GravarAlteracao(document.frmTurma)" class="redefine" style="height: 35px;width: 120px;margin-left: 15px;">REDEFINIR</button>
