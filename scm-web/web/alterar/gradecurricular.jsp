...
<% GradeCurricular grade = (GradeCurricular) request.getAttribute("grade");%>
    ...
    <body class="html">  
        ...
        <div id="content" class="" style="">  
            <div id="menu" class="hide">   
                <h1>MENU</h1>
                <ul> 
                    <a href="scm/home.jsp"><li><span>Home</span></li></a> <a href="ajuda.html"><li><span>Ajuda</span></li></a> <a href="about.html"><li><span>Sobre nós</span></li></a> </ul>
            </div>
            <div id="wrapper" class="">
                ...
                <div class="form_container">
                    <h1 class="form_title">Alterar dados da grade curricular</h1>



                    <form name="frmGradeCurricular" method="post" action=""><table style="">
                            <tbody>
                                <tr style="">
                                ...
                                <tr>
                                    <td id="field"><span>Curso</span></td>
                                    <td>
                                        <select name="curso" class="form_input">
                                            <%
                                                List<Curso> listCurso = (List<Curso>) request.getAttribute("listCurso");
                                                for (Curso cur : listCurso) {
                                            %>
                                            <option                                     
                                                value='<%=cur.getId()%>'><%=cur.getNome()%>
                                            </option>
                                            <%  }%>
                                        </select>
                                    </td>  
                                ...
                                <tr>
                                    <td id="field"><span>Número da série</span></td>
                                    <td><input class="form_input" name="numero" type="text" value="<%= grade.getSerie()%>" placeholder="Nome"></td>
                                </tr>  
                                <tr>
                                    <td id="field"><span>Descrição</span></td>
                                    <td><input class="form_input" name="descricao" type="text" value="<%= grade.getDescricao()%>" placeholder="Descrição"></td>
                                </tr> 
                            </tbody></table>
                        <div class="butcontainer">
                            <input type="reset" value="CANCELAR" class="cancela" style=" height: 35px; width: 120px;">
                            <button onclick="GravarAlteracao(document.frmGradeCurricular)" class="redefine" style="height: 35px;width: 120px;margin-left: 15px;">REDEFINIR</button> 
