...
<html lang="en" style="
    ...
    <body class="html">  
        ...
        <div id="content" class="" style="">  
            <div id="menu" class="hide"> <h1>MENU</h1> <ul> <a href="scm/home.jsp"><li><span>Home</span></li></a> <a href="ajuda.html"><li><span>Ajuda</span></li></a> <a href="about.html"><li><span>Sobre nós</span></li></a> </ul> </div>
            <div id="wrapper" class="">
                ...
                <div class="form_container">
                    <h1 class="form_title">Alterar dados de disciplina</h1>
                    ...
                    <form name="frmDisciplina" method="post" action=""><table style="">
                            <tbody>
                                <tr style="">
                                    ...
                                    <td><input class="form_input" name="id" type="text" value="<%= disciplina.getId()%>" placeholder="ID"></td>
                                </tr>
                                <tr style="">
                                ...
                                <tr> 
                                    ...
                                    <td><input class="form_input" name="carga" type="text" value="<%= disciplina.getCargaHoraria()%>" placeholder="Carga Horária"></td>
                                </tr>
                                <tr style="">
                                    <td id="field"><span>Nome</span></td>
                                    <td><input class="form_input" name="nome" type="text" value="<%= disciplina.getNome()%>" placeholder="Nome"></td>
                                </tr>
                                <tr style="border: 1px solid gray;">
                                    <td id="field" style=""><span>Ementa</span></td>
                                    <td><input class="form_input" name="ementa" type="text" value="<%= disciplina.getEmenta()%>" placeholder="Ementa" style=""></td>
                                </tr>
                            </tbody></table>
