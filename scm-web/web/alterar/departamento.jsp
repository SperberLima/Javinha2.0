        ...
        <div id="content" class="" style="">  
            ...
            <div id="wrapper" class="">
                ...
                <div class="form_container">
                    <h1 class="form_title">Alterar dados de departamento</h1>



                    <form name="frmDepartamento" method="post" action=""><table style="
                                                                                ">
                            <tbody>
                                <tr style="">
                                    <td id="field" style="
                                        "><span style="
                                            font-size: 16px;
                                            ">ID</span></td>
                                    <td><input class="form_input" name="id" type="text" value="<%= departamento.getId() %>" placeholder="ID"></td>
                                </tr>
                                <tr>
                                    <td id="field"><span>Sigla</span></td>
                                    <td><input class="form_input" name="sigla" type="text" value="<%= departamento.getSigla() %>" placeholder="Sigla"></td>
                                </tr>
                                <tr>
                                    <td id="field"><span>Unidade</span></td>    
                                    <td>
                                        <select name="unidade" class="form_input">
                                            <%
                                               List<UnidadeEnsino> listUnidade = (List<UnidadeEnsino>) request.getAttribute("listUnidade");
                                ...
                                <tr style="
                                    ...
                                    <td><input class="form_input" name="nome" type="text" value="<%= departamento.getNome() %>" placeholder="Nome"></td>
                                </tr>
                                <tr>
                                    <td id="field" style="
                                        "><span>E-mail</span></td>
                                    <td><input class="form_input" name="email" type="text" value="<%= departamento.getEmail() %>" placeholder="E-mail" style="
                                               "></td>
                                </tr>
                                <tr>
                                    <td id="field" style="
                                        "><span>Telefone</span></td>
                                    <td><input class="form_input" name="telefone" type="text" value="<%= departamento.getTelefone() %>" placeholder="Telefone" style="
                                               "></td>
                                </tr>
                                <tr>
                                    <td id="field" style="
                                        "><span>CEP</span></td>
                                    <td><input class="form_input" name="cep" type="text" value="<%= departamento.getCEP() %>" placeholder="CEP" style="
                                               "></td>
                                </tr> 
                                <tr style="border: 1px solid gray;">
                                    <td id="field" style="
                                        "><span>Site</span></td>
                                    <td><input class="form_input" name="site" type="text" value="<%= departamento.getSite() %>" placeholder="Site" style="
                                               "></td>
                                </tr>  
                            </tbody></table>
                        <div class="butcontainer">
                            <input type="reset" value="CANCELAR" class="cancela" style=" height: 35px; width: 120px;"><button onclick="GravarAlteracao(document.frmDepartamento)" class="redefine" style="
                                                                                                                              height: 35px;
                                                                                                                              width: 120px;
                                                                                                                              margin-left: 15px;
                                                                                                                              ">REDEFINIR</button> 
