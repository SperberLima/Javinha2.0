        ...
        <div id="content" class="" style="">  
            ...
            <div id="wrapper" class="">
                ...
                <div class="form_container">
                    <h1 class="form_title">Lista de grades curriculares</h1>

                    <form name="frmGradeCurricular" method="post" action="/scm/servletweb" style="padding: 0px 20px;">
                        <table class="view">
                            <tbody><tr style="">
                                    <th>
                                        ID
                                ...
                                <%
                                    List<GradeCurricular> listGCurricular = (List<GradeCurricular>) request.getAttribute("listGradeCurricular");
                                    for (GradeCurricular gradec : listGCurricular) {
                                %>
                                <tr>
                                    <td>
                                        <%=gradec.getId()%>
                                    ...
                                    <td style="padding-right: 10px;">                            
                                        <a href="/scm/servletweb?acao=AlterarGradeCurricular&IdGradeCurricular=<%=gradec.getId()%>"><div id="alterar"></div></a>
                                    </td>
                                    <td style="padding-right: 0px;">                            
                                        <button id="excluir" onclick="Excluir(<%=gradec.getId()%>, document.frmGradeCurricular);"></button>
                                    </td>
                                </tr>
                            </tbody><% }%></table>
                    </form>
