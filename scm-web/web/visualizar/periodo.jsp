        ...
        <div id="content" class="" style="">  
            ...
            <div id="wrapper" class="">
                ...
                <div class="form_container">
                    <h1 class="form_title">Lista de períodos</h1>

                    <form name="frmPeriodo" method="post" action="/scm/servletweb" style="padding: 0px 20px;">
                        <table class="view">
                            <tbody><tr style="
                                       ">
                                    <th>
                                ...
                                <%
                                    List<PeriodoLetivo> listPeriodo = (List<PeriodoLetivo>) request.getAttribute("listPeriodoLetivo");
                                    for (PeriodoLetivo periodo : listPeriodo) {
                                %>
                                <tr style="
                                    ">
                                    <td>
                                    ...
                                    <td style="
                                        padding-right: 10px;
                                        ">                            
                                        <a href="/scm/servletweb?acao=AlterarPeriodo&IdPeriodo=<%=periodo.getId()%>"><div id="alterar"></div></a>
                                    </td>
                                    <td style="padding-right: 0px;">                            
                                        <button id="excluir" onclick="Excluir(<%=periodo.getId()%>, document.frmPeriodo);"></button>
                                    </td>
                                </tr>
                            </tbody>
                            <%  }%></table>
