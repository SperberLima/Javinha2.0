        ...
        <div id="content" class="" style="">  
            ...
            <div id="wrapper" class="">
                ...
                <div class="form_container">
                    <h1 class="form_title">Lista de relações Grade Disciplina </h1>

                    <form name="frmGradeDisciplina" method="post" action="/scm/servletweb" style="padding: 0px 20px;">
                        <table class="view">
                            <tbody><tr style="">
                                    <th>
                                        ID
                               ...
                               <%
                                    List<GradeDisciplina> listGDisciplina = (List<GradeDisciplina>) request.getAttribute("listGradeDisciplina");
                                    for (GradeDisciplina graded : listGDisciplina) {
                                %>
                                <tr>
                                    <td>
                                        <%=graded.getId()%>
                                    ...
                                    <td>
                                        <%=graded.getGradeCurricular()%>
                                    </td>
                                    <td>
                                        <%=graded.getDisciplina()%>
                                    </td>

                                    <td style="padding-right: 10px;">                            
                                        <a href="/scm/servletweb?acao=AlterarGradeDisciplina&IdGradeDisciplina=<%=graded.getId()%>"><div id="alterar"></div></a>
                                    </td>
                                    <td style="padding-right: 0px;">                            
                                        <button id="excluir" onclick="Excluir(<%=graded.getId()%>, document.frmGradeDisciplina);"></button>
                                    </td>
                                </tr>
                            </tbody><% }%></table>
                    </form>
