        ...
        <div id="content" class="" style="">  
            ...
            <div id="wrapper" class="">
                ...
                <div class="form_container">
                    ...
                    <form name="frmHorario" method="post" action="/scm/servletweb" style="padding: 0px 20px;">
                        <table class="view">
                            <tbody><tr style="">
                                    <th>
                                        ID
                                ...
                                <%
                                    List<Horario> listHorario = (List<Horario>) request.getAttribute("listHorario");
                                ...
                                <tr>
                                    ...
                                    <td style="padding-right: 10px;">                            
                                        <a href="/scm/servletweb?acao=AlterarHorario&IdHorario=<%=hor.getId()%>"><div id="alterar"></div></a>
                                    </td>
                                    <td style="padding-right: 0px;">                            
                                        <button id="excluir" onclick="Excluir(<%=hor.getId()%>, document.frmHorario);"></button>
                                    </td>
                                </tr>
                            </tbody><%  }%></table>
                    </form>
