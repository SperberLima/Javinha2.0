        ...
        <div id="content" class="" style="">  
            ...
            <div id="wrapper" class="">
                ...
                <div class="form_container">
                    <h1 class="form_title">Lista de disciplinas</h1>

                    <form name="frmDisciplina" method="post" action="">
                        <table class="view">
                            <tbody><tr style="">
                                    <th>
                                        ID
                                ...
                                <%
                                    List<Disciplina> listDisciplina = (List<Disciplina>) request.getAttribute("disciplina");
                                ...
                                <tr style="
                                    ...
                                    <td style="
                                        padding-right: 10px;
                                        ">                            
                                        <a href="/scm/servletweb?acao=AlterarDisciplina&IdDisciplina=<%=disc.getId()%>"><div id="alterar"></div></a>
                                    </td>
                                    <td style="padding-right: 0px;">                            
                                        <button id="excluir" onclick="Excluir(<%=disc.getId()%>, document.frmDisciplina);"></button>
                                    </td>
                                </tr>
                            </tbody><%  }%></table>
                    </form>
