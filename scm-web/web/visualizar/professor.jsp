        ...
        <div id="content" class="" style="">  
            ...
            <div id="wrapper" class="">
                ...
                <div class="form_container">
                    ...
                    <form name="frmProfessor" method="post" action="/scm/servletweb" style="padding: 0px 20px;">
                        <table class="view">
                            <tbody><tr style="
                                       ">
                                    <th>
                                ...
                                <tr style="">
                                    ...
                                    <td style="padding-right: 10px;">                            
                                        <a href="/scm/servletweb?acao=AlterarProfessor&IdProfessor=<%=prof.getId()%>"><div id="alterar"></div></a>
                                    </td>
                                    <td style="padding-right: 0px;">                            
                                        <button id="excluir" onclick="Excluir(<%=prof.getId()%>, document.frmProfessor);"></button>
                                    </td>
                                </tr>
                            </tbody><%  }%></table>
                    </form>
