        ...
        <div id="content" class="" style="">  
            ...
            <div id="wrapper" class="">
                ...
                <div class="form_container">
                    <h1 class="form_title">Lista de turmas</h1>

                    <form name="frmTurma" method="post" action="">
                        <table class="view">
                            <tbody><tr style="">
                                    <th>
                                        ID
                                ...
                                <%
                                    List<Turma> listTurma = (List<Turma>) request.getAttribute("turma");
                                ...
                                <tr>
                                    ...
                                    <td style="padding-right: 10px;">                            
                                        <a href="/scm/servletweb?acao=AlterarTurma&IdTurma=<%=turma.getId()%>"><div id="alterar"></div></a>
                                    </td>
                                    <td style="padding-right: 0px;">                            
                                        <button id="excluir" onclick="Excluir(<%=turma.getId()%>, document.frmTurma);"></button>
                                    </td>
                                </tr>
                            </tbody><%  }%></table>
                    </form>
