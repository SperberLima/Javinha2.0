        ...
        <div id="content" class="" style="">  
            ...
            <div id="wrapper" class="">
                ...
                <div class="form_container">
                    ...
                    <form name="frmAmbiente" method="post" action="/scm/servletweb" style="padding: 0px 20px;">
                        <table class="view">
                            <tbody><tr style="">
                                    <th>
                                        ID
                                    ...
                                    <th style="padding-right: 0px;"></th><th style="padding-right: 0px;"></th>
                                </tr>			
                                <%
                                    List<AmbienteAprendizagem> listAmbienteA = (List<AmbienteAprendizagem>) request.getAttribute("listAmbienteAprendizagem");
                                    for (AmbienteAprendizagem a_a : listAmbienteA) {
                                %>
                                <tr>
                                    <td>
                                        <%=a_a.getId()%>
                                    ...
                                    <td style="padding-right: 10px;">                            
                                        <a href="/scm/servletweb?acao=AlterarAmbiente&IdAmbiente=<%=a_a.getId()%>"><div id="alterar"></div></a>
                                    </td>
                                    <td style="padding-right: 0px;">                            
                                        <button id="excluir" onclick="Excluir(<%=a_a.getId()%>, document.frmAmbiente);"></button>
                                    </td>
                                </tr>
                            </tbody><%  }%></table>
                    </form>
