...
">
    ...
    <td><input class="form_input" name="capacidade" type="text" value="" placeholder="Capacidade"></td>
  </tr>
  <tr style="border: 1px solid gray;">
    <td id="field" style="
"><span>Número da sala</span></td> 
    <td><input class="form_input" name="numero" type="text" value="" placeholder="Número da sala" style="
"></td>
  </tr> 
</tbody></table>
