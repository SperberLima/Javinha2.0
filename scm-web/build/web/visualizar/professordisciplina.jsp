        ...
        <div id="content" class="" style="">  
            ...
            <div id="wrapper" class="">
                ...
                <div class="form_container">
                    ...
                    <form name="frmProfessorDisciplina" method="post" action="">
                        <table class="view">
                            <tbody><tr style="">
                                    <th>
                                        ID
                                ...
                                <%
                                    List<ProfessorDisciplina> listProfDisciplina = (List<ProfessorDisciplina>) request.getAttribute("professorDisciplina");
