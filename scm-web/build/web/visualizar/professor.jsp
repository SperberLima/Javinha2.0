                    ...
                    <form name="frmProfessor" method="post" action="">
                        <table class="view">
                            <tbody><tr style="
                                ...
                                <tr style="">
                                    <td>
                                        <input class="form_input" type="text" name="id" value="<%=prof.getId()%>" readonly/>
                                    </td>
                                    <td>
                                        <input class="form_input" type="text" name="id" value="<%=prof.getCPF()%>" readonly/>
                                    </td>
                                    <td>
                                        <input class="form_input" type="text" name="id" value="<%=prof.getDpto()%>" readonly/>
                                    </td>
                                    <td>
                                       <input class="form_input" type="text" name="id" value="<%=prof.getNome()%>" readonly/>
                                    </td>
                                    <td>
                                        <input class="form_input" type="text" name="id" value="<%=prof.getTelefone()%>" readonly/>
                                    </td> 
                                    <td> 
                                        <input class="form_input" type="text" name="id" value="<%=prof.Descricao()%>" readonly/>
                                    </td> 
                                    <td style="padding-right: 10px;">                            
                                        <button id="alterar" onclick=""></button>
                                    </td>
                                    <td style="padding-right: 0px;">                            
                                        <button id="excluir" onclick="Excluir(document.frmProfessor.id.value, document.frmProfessor);"></button>
                                    </td>
                                </tr>
                            </tbody><%  }%></table>
                    </form>
